...
print(f"{max(tuple(zip(hours, days)))[1]}요일")                          # ✅ 토요일
...
print(max(scores))                                                    # ✅ max 점수: 92점, min 점수: 76점
print(min(scores))

print(sorted(scores)[-1], sorted(scores)[0])                                                    # ✅ max 점수: 92점, min 점수: 76점
...
total = sum(price for _, price, qty in zip(*stocks))
print(f"총액: {total:,}원")